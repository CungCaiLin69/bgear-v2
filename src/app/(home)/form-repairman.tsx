...
const BecomeRepairmanForm = () => {
  const { user, repairman, becomeRepairman, checkRepairmanStatus, resignAsRepairman } = useAuth();
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert('Success', repairman ? 'Repairman profile updated!' : 'You are now a repairman!');
      navigation.goBack()
    } catch (error) {
  ...
  return (
    <View style={styles.container}>
      ...
      {repairman && <Text style={styles.subtitle}>You are already a repairman.</Text>}
      ...
      >
        ...
        <Text style={styles.checkboxText}>Do you have a shop or work in a shop?</Text>
      </TouchableOpacity>
